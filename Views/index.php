...
<main style="background-color: #f9f9f9;">
    ...
    <a  href="https://wa.me/<?php echo formatPhoneNumber(TELEFONO); ?>" class="whatsapp-float p-3" style="background-color: #5ABD43;" target="_blank"><i class="bi bi-whatsapp rounded fs-3 text-white"></i></a>
    <!-- Fin boton whatsapp-->
