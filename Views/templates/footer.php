<footer class="pt-5 shadow border-top">
    <div class="footer pb-4 border-bottom">
            ...
            <div class="row">
                ...
                <div class="col-md-3 pe-md-4 mt-5 mt-md-0">
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <a href="<?php echo INSTRAGRAM; ?>" target="_blank"><i class="fab fa-instagram"></i>
                            Instagram</a>
        ...
        <div class="footer py-4 copyright text-center">
            <p style="font-size: 13px;" class="mb-0">&copy; 2024 Construye tu tienda online con IMPORSUIT S.A. | Todos
