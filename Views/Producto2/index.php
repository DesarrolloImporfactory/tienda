                    ...
                    <div class="col-12 col-lg-6 mb-5">
                        ...
                        <div class="mb-3 d-flex">
                            <img id="mainProductImage" src=""
                                 class="mx-auto img-fluid main-product-image rounded border shadow"
                                 alt="Main Product Image"
                                 onclick="abrir_modalImagen(this.src)">
                        </div>
                        <!-- Thumbnails -->
                        <div class="thumbnail-container d-flex w-100 scroll-y-imagenes mx-auto"
                        ...
                        $('#comprar-ahora').on('click', function () {
                            ...
                            if (isMeta)
                                fbq('track', 'InitiateCheckout', {
                                    ...
                                    value: parseFloat(producto.pvp_tienda),
                                    currency: 'USD',
